...
public class StarWars {
    ...
    public void female(){
        ...
        List<Map<String,Object>>  listofCharacters= (List<Map<String, Object>>) deserializedResponse.get("results");
        int count=0;
        for (int i=0;i<listofCharacters.size();i++){

            if(listofCharacters.get(i).get("gender").equals("female")){
                System.out.println(listofCharacters.get(i).get("gender"));
                count++;
            }
        }
